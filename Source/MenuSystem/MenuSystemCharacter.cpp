...
void AMenuSystemCharacter::CreateGameSession()
{
	...
	SessionSettings->Set(FName("MatchType"), FString("FreeForAll"), EOnlineDataAdvertisementType::ViaOnlineServiceAndPing); // Useful
	...
	else
	{
		if (GEngine)
		{
			GEngine->AddOnScreenDebugMessage(
				...
				15.0f,
				FColor::Red,
				FString(TEXT("Didn't find any session")));
		}
	}
}
